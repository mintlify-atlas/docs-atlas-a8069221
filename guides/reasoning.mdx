...
description: "Set reasoning effort on OpenAI o-series models like o3 and o4-mini using the PHP AI SDK Reasoning helper — and understand the portable token budget limitation."
---
