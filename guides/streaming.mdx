---
title: "Streaming OpenAI Responses in Real Time with PHP AI SDK"
sidebarTitle: "Streaming"
description: "Stream OpenAI tokens in real time with the PHP AI SDK — iterate chunks(), access usage and finish reason from FinishPart, and handle reasoning deltas."
---
