---
title: "OpenAI Tool Calling in PHP: Define and Invoke Model Tools"
sidebarTitle: "Tool Calling"
description: "Define typed PHP tools for OpenAI — configure tool_choice, handle multi-tool requests, and read ToolCallPart id, name, and arguments."
---
