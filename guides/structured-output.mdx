---
title: "Extracting Structured JSON Output from OpenAI in PHP AI SDK"
sidebarTitle: "Structured Output"
description: "Use json_schema to get structured data from OpenAI — define schemas with Schema::object() and decode results from $result->text."
---
