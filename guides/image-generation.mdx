---
title: "Generate Images with OpenAI Models in PHP"
sidebarTitle: "Image Generation"
description: "Generate images from gpt-image-1, DALL-E 3, and DALL-E 2 using the PHP AI SDK — set size, aspect ratio, count, and provider-specific options like background transparency."
---
...
```
OpenAI image generation does not support the portable seed() option.
Use providerOptions('openai', ...) if this model or endpoint adds provider-specific seed support.
```
</Warning>
...
```
OpenAI image generation does not support aspect ratio [21:9].
Use size() or providerOptions('openai', ...).
```
</Warning>
